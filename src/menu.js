   ...
   switch (type) {
      case "p":
         for (var i = 0; i < count; i++) {
            result += loremIpsum[Math.floor( Math.random() * loremIpsum.length )] + "\n\n";
         };
         break;
      case "w":
         var cnt = 0;
         ...
         while(cnt < count) {
            var sampleStringWords = loremIpsum[Math.floor( Math.random() * loremIpsum.length )].split(" ");
...
function onClickHandler(info, tab) {
   ...
   switch (info.menuItemId){
      case "paragraph1":
         insertText = getLorem(1, "p");
         break;
      case "paragraph2":
         insertText = getLorem(2, "p");
         break;
      case "paragraph3":
         insertText = getLorem(3, "p");
         break;
      case "paragraph5":
         insertText = getLorem(5, "p");
         break;
      case "paragraph10":
         insertText = getLorem(10, "p");
         break;
      case "word1":
         insertText = getLorem(1, "w");
         break;
      case "word2":
         insertText = getLorem(2, "w");
         break;
      case "word3":
         insertText = getLorem(3, "w");
         break;
      case "word5":
         insertText = getLorem(5, "w");
         break;
      case "word10":
...
chrome.runtime.onInstalled.addListener(function() {
   ...
   chrome.contextMenus.create({"title": "Insert Paragraphs", "id": "paragraphs", "parentId": "root", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "1",  "id": "paragraph1", "parentId": "paragraphs", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "2",  "id": "paragraph2", "parentId": "paragraphs", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "3",  "id": "paragraph3", "parentId": "paragraphs", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "5",  "id": "paragraph5", "parentId": "paragraphs", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "10", "id": "paragraph10", "parentId": "paragraphs", "contexts": ["editable"]});

   chrome.contextMenus.create({"title": "Insert Words", "id": "words", "parentId": "root", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "1", "id": "word1", "parentId": "words", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "2", "id": "word2", "parentId": "words", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "3", "id": "word3", "parentId": "words", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "5", "id": "word5", "parentId": "words", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "10", "id": "word10", "parentId": "words", "contexts": ["editable"]});
   chrome.contextMenus.create({"title": "...", "id": "wordUser", "parentId": "words", "contexts": ["editable"]});
